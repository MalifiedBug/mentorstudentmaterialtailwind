...
import { PencilIcon, UserIcon,TrashIcon, PhoneIcon } from '@heroicons/react/24/solid'
          ...
          >
            ...
            <DialogFooter>
              ...
              <Button
                ...
                onClick={() => {
                  axios
                    .delete(`${mentorStudentUrl}/deletementor/${mentor.name}`)
